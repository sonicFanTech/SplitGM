...
$knownPaths = @(
    ...
    (Join-Path $root 'src\SGMVMDLauncher\bin'),
    (Join-Path $root 'src\SGMVMDLauncher\obj'),
    (Join-Path $root 'src\SGMVMDLauncher.Playback\bin'),
    (Join-Path $root 'src\SGMVMDLauncher.Playback\obj'),
